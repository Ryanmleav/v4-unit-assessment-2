...
let foundZ =function () {
   ...
   nestedLetters[i] == 'z'
   for (let j = 0; j < [nestedLetters].length;i++){
       nestedLetters[i] == 'z'
   }
}
}
            ...
            */
            ...
            //CODE HERE
            let fidoSpeak = bark.call(fido, 'fido')
            ...
            */
            ...
            //CODE HERE
            let phone1 = new Phone('apple', 'iphone', 125, 'green', false)

            let phone2 = new Phone('samsung', 's20', 125, 'black', false)

            let phone3 = new Phone('nokia', 'brick', 5, 'blue', false)
